...
# Change 1: 'all' now only depends on $(BUILD).
all: $(BUILD)
...
# Change 2: $(BUILD) now depends on download_grrlib.
# This forces make to finish the download BEFORE starting the recursive build.
$(BUILD): download_grrlib
	@[ -d $@ ] || mkdir -p $@
